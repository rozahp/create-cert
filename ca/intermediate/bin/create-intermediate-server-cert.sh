#!/bin/bash
##
## Filename:	create-intermediate-server-cert.sh
##
...
openssl req -config intermediate/config/openssl-intermediate-server.conf \
...
openssl ca -config intermediate/config/openssl-intermediate-server.conf \
